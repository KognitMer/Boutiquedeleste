...
export const metadata: Metadata = {
  ...
  description: 'Perfumería, maquillaje y cuidado personal Natura con entregas en 24 horas en Maldonado y Punta del Este.',
  openGraph: {
    title: 'Natura Uruguay · Belleza que hace bien',
    description: 'Descubrí perfumería, maquillaje y cuidado personal con entregas en 24 horas en Maldonado y Punta del Este.',
    type: 'website',
